{
====================================================================
EJERCICIO 5 (a) - ALCANCE DE IDENTIFICADORES
====================================================================
...
- c : Constante     (declarada en el programa x)
- d : Variable      (declarada en el programa x)
- e : Variable      (declarada en el procedimiento y; oculta a la variable e de x)
- f : Variable      (declarada en el programa x)
...
- c : Constante     (declarada en el programa x)
- d : Variable      (declarada en el programa x)
- e : Variable      (declarada en el procedimiento y)
